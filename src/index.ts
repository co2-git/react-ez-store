...
const t = async () => {
  ...
  console.log({ number: store.get(number) })

  await store.set(number, 1)

  console.log({ number: store.get(number) })

  await store.increment(number)

  console.log({ number: store.get(number) })

  await store.increment(number, 2)

  console.log({ number: store.get(number) })

  await store.decrement(number)

  console.log({ number: store.get(number) })

  await store.decrement(number, 2)

  console.log({ number: store.get(number) })

  await store.multiply(number, 10)

  console.log({ number: store.get(number) })

  await store.divide(number, 2)

  console.log({ number: store.get(number) })

  await store.reset(number)
